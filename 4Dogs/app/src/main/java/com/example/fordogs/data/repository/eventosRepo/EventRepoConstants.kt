...
class EventRepoConstants {

    companion object{
        const val NO_EVENTS = "No hay eventos"
        const val ERROR_GET_EVENT = "No existe el evento"
        const val ERROR_CREATE_EVENT = "Error al crear evento"
        const val ERROR_UPDATE_EVENT = "Error al actualizar evento"
